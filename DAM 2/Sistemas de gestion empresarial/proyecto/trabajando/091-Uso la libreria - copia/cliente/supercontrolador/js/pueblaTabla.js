        ...
        datos.forEach(function(registro){                                       // Como datos es un array, hago un forEach para repasarlo
            ...
            Object.keys(registro).forEach(clave => {                            // Fórmula para recorrer correctamente las propiedades de un objeto
                ...
                if(clave === "foto"){
                    ...
                    nuevacolumna.innerHTML = "<img src='"+registro[clave]+"' width='50px'>"  // Si la clave es foto, entonces le pongo una imagen
                    }else{
                        nuevacolumna.innerHTML = "<img src='img/no-image.png' width='50px'>"  // Si la clave es foto, entonces le pongo una imagen
                    }
                }else{
            ...
            nuevacolumna.innerHTML = "<span class='boton botonrojo'><img src='img/iconoborrar2.svg'></span>"                                     // Le doy el emoji de la papelera
