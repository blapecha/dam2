...
tk.Button(marco,text="Guardamos este cliente",command=guardaCliente,bg="blue").pack(padx=10,pady=10)
tk.Button(marco,text="Guardamos todos los clientes a base de datos",command=guardaDB,bg="green").pack(padx=10,pady=10)
